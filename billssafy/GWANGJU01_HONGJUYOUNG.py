...
NICKNAME = 'GWANGJU01_HONGJUYOUNG'
...
while True:
    ...
    while True:
        if balls[i][0] == -1:
            ...
            break
    targetBall_x = balls[play2[i]][0]
    targetBall_y = balls[play2[i]][1]
    ...
    r = 2.85
    t_h = HOLES[5]
    radian = math.atan(abs(targetBall_y-whiteBall_y) / abs(HOLES[5][0] - whiteBall_x)) if abs(HOLES[5][0] - whiteBall_x) > 0 else 0
